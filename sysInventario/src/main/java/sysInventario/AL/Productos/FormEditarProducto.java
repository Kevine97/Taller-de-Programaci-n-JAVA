...
import static sysInventario.AL.Productos.FormProductos.codigo;
...
public class FormEditarProducto extends javax.swing.JDialog {
    ...
    public void cargar() {
        ...
        txtProducto.setText(FormProductos.nombre);
        txtActual.setText(String.valueOf(FormProductos.actual));
        txtMinima.setText(String.valueOf(FormProductos.minimo));
        System.out.println();
    ...
    public FormEditarProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargar();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EDIATAR PRODUCTO");
    ...
    private void btnRegistrarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRegistrarMousePressed
        ...
        Repuesta resp;
        try {
            pro.setIdProdcuto(Integer.parseInt(formProducto.codigo));
            pro.setNombreProducto(txtProducto.getText());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormEditarProducto dialog = new FormEditarProducto(new javax.swing.JFrame(), true);
    ...
    public static javax.swing.JTextField txtMinima;
